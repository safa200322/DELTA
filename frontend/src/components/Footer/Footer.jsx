        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Famagusta, North Cyprus</p>
              <p className="office__info">Phone: +90 (548) 000 0000</p>

              <p className="office__info">Email: deltaquickrent@gmail.com</p>
          ...
          <Col lg="3" md="4" sm="12">
            <div className="mb-4">
              ...
              <div className="newsletter">
                ...
                <span>
                  <i className="ri-send-plane-line" style={{ color: "#005566" }}></i>
                </span>
              </div>
            </div>
          </Col>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                <i className="ri-copyright-line"></i>Copyright {year}, Developed by group 1. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
